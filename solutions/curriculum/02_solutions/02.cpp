...
int main()
{
    // Írj programot, ami bekér egy számot, és kiírja, hogy nagyobb-e 10-nél!  
    int number;
    ...
    // Írj programot, ami bekér egy számot, és kiírja, hogy kisebb-e 100-nál!
    cout << "Adj meg egy szamot: ";
    cin >> number;
    if (number < 100) {
    ...
    // Írj programot, ami bekér egy számot, és kiírja, hogy pozitív vagy nem!  
    cout << "Adj meg egy szamot: ";
    cin >> number;
    if (number > 0) {
    ...
    // Írj programot, ami bekér egy számot, és kiírja, hogy páros vagy páratlan!
    cout << "Adj meg egy szamot: ";
    cin >> number;
    if (number % 2 == 0) {
    ...
    // Írj programot, ami bekér egy számot, és kiírja, hogy pozitív, negatív vagy nulla!  
    cout << "Adj meg egy szamot: ";
    cin >> number;
    if (number > 0) {
        cout << "A szam pozitiv." << endl;
    ...
    //Írj programot, ami bekér egy számot, és eldönti róla, hogy osztható-e 3-mal, 5-tel vagy mindkettővel!
    cout << "Adj meg egy szamot: ";
    cin >> number;
    ...
    // Írj programot, ami bekér egy jegyet (A–F), és szöveges értékelést ad rá!
    char grade;
    ...
    // Írj programot, ami bekér egy számot 1–7 között, és kiírja a hét megfelelő napját!
    int day;
    ...
    // Írj programot, ami kiírja az 1–10 közötti számokat!
    for (int i = 1; i <= 10; i++) {
        cout << i << " ";
    }
    cout << endl;

    // Írj programot, ami kiírja az 1–20 közötti páros számokat!
    for (int i = 1; i <= 20; i++) {
        if (i % 2 == 0) {
            cout << i << " ";
        }
    ...
    // Írj programot, ami kiírja egy tömb minden elemét!
    int arr[] = {1, 2, 3, 4, 5};
    for (int i = 0; i < 5; i++) {
        cout << arr[i] << " ";
    }
    ...
    // Írj programot, ami összeadja egy tömb elemeit!
    int sum = 0;
    for (int i = 0; i < 5; i++) {
        sum += arr[i];
    }
    ...
    // Írj programot, ami kiírja a tömb elemeit range-based for ciklussal!
    for (const auto& elem : arr) {
        cout << elem << " ";
    }
    cout << endl;

    // Írj programot, ami megszámolja, hány páros szám van a tömbben!
    int count = 0;
    for (const auto& elem : arr) {
        if (elem % 2 == 0) {
            count++;
    ...
    // Írj programot, ami while ciklussal kiírja az 1–10 közötti számokat!
    ...
    // Írj programot, ami while ciklussal összeadja az 1–n közötti számokat!
    int n;
    ...
    // Írj programot, ami do-while ciklussal legalább egyszer kiír egy üzenetet!
    string message;
    do {
    ...
    // Írj programot, ami do-while ciklussal addig kér be számot, amíg a felhasználó nullát nem ad meg!
    int num;
    do {
    ...
    // Írj programot, ami 1–10 között kiír minden számot, kivéve az 5-öst!
    ...
    // Írj programot, ami 1–20 között kiírja a számokat, de ha 13-hoz ér, kilép a ciklusból!
    ...
    // Írj programot, ami beágyazott ciklussal kirajzol egy 5×5-ös négyzetet `*` karakterekből!
    ...
    // Írj programot, ami beágyazott ciklussal kirajzol egy derékszögű háromszöget `*` karakterekből!
