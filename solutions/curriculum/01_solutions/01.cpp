...
int main()
{
    ...
    // Írj programot, ami két sort ír ki: az elsőben a kedvenc focicsapatod, a másodikban a kedvenc filmedet!
    cout << "Kedvenc focicsapat: FC Bayern Munchen" << endl;
    cout << "Kedvenc film: Interstellar" << endl;

    // Írj programot, amelyben tárolod a saját neved, életkorod és azt, hogy tanuló vagy-e, majd írd ki őket!
    ...
    // Írj programot, amelyben eltárolod egy könyv címét, szerzőjét és oldalszámát, majd jelenítsd meg!
    ...
    // Írj programot, ami eltárolja egy kör sugarát, majd kiírja a kör kerületét a konstans `PI` felhasználásával! 
    const double PI = 3.14159;
    double sugar = 5.0;
    double kerulet = 2 * PI * sugar;
    cout << "Kor kerulete: " << kerulet << endl;

    // Írj programot, ami kiszámítja egy négyzet területét, és a számításnál konstansként használd az oldalhosszt!
    const double oldalHossz = 4.0;
    double terulet = oldalHossz * oldalHossz;
    cout << "Negyzet terulete: " << terulet << endl;

    // Írj programot, amelyben `auto`-val létrehozol három különböző típusú változót, majd kiírod őket!
    auto szoveg = "Hello, C++!";
    auto szam = 42;
    auto tizedes = 3.14;
    ...
    // Írj programot, amely két `auto` típusú változót összead, és kiírja az eredményt!
    auto osszeg = szam + tizedes;
    cout << "Osszeg: " << osszeg << endl;

    // Írj programot, ami bekér két egész számot, majd lebegőpontos osztással kiszámítja a hányadosukat!  
    int a, b;
    ...
    // Írj programot, ami Celsius fokot Fahrenheitre vált át, lebegőpontos számítással!
    double celsius;
    ...
    // Írj programot, ami bekéri a neved és az életkorod, majd kiírja egy mondatban!  
    ...
    // Írj programot, ami bekér egy számot, majd kiírja a négyzetét!
    int szam;
    cout << "Kerek egy egesz szamot: ";
    cin >> szam;
    cout << "A szam negyzete: " << szam * szam << endl;

    // Írj programot, ami bekér két számot, és kiírja a különbséget, szorzatot és hányadost!
    int x, y;
    cout << "Kerek ket egesz szamot: ";
    cin >> x >> y;
    ...
    // Írj programot, ami bekér egy számot, és kiírja a szám maradékát, ha elosztod 3-mal!
    int szam3;
    cout << "Kerek egy egesz szamot: ";
    cin >> szam3;
